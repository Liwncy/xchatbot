...
const groups = [
    ...
    },
    {
        ...
        commands: [
            ...
            {id: 'd1:migrate:remote:roleplay', description: '初始化远端演法角色表并灌入目录。', shell: 'wrangler d1 execute xbotdata --remote --file "./_docs/roleplay/roleplay-character.sql"'},
            {id: 'roleplay:from-mysql', description: '从 one-agbot MySQL 种子生成 D1 演法目录 SQL。', shell: 'node ./_docs/scripts/roleplay-from-mysql.cjs'},
